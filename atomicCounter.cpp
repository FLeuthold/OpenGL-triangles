...
class my_application : public sb7::application {
	...
	virtual void startup()
	{
		...
		static const char * fs_2_source[] =
		{
			...
			"                                             \n"
			"void main(void){                             \n"
			"	float brightness = clamp(float(counter_value) *10.0/ max_area, 0.0, 1.0); \n"
		...
		//Create a counter buffer for fs_2
		GLuint buf;
		glGenBuffers(1, &buf);
